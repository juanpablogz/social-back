...
class RoomUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_user" do
    assert_difference('RoomUser.count') do
      post room_users_url, params: { room_user: { name: @room_user.name, room_id: @room_user.room_id, user_id: @room_user.user_id } }, as: :json
    end
  ...
  test "should update room_user" do
    patch room_user_url(@room_user), params: { room_user: { name: @room_user.name, room_id: @room_user.room_id, user_id: @room_user.user_id } }, as: :json
    assert_response 200
  end
