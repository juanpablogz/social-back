...
class RoomMessagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_message" do
    assert_difference('RoomMessage.count') do
      post room_messages_url, params: { room_message: { message_id: @room_message.message_id, room_id: @room_message.room_id } }, as: :json
    end
  ...
  test "should update room_message" do
    patch room_message_url(@room_message), params: { room_message: { message_id: @room_message.message_id, room_id: @room_message.room_id } }, as: :json
    assert_response 200
  end
